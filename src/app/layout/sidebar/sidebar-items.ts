...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      {
        path: '/admin/personnel/allpersonals',
        title: 'Staff List',
        iconType: '',
        icon: '',
        class: 'ml-menu',
   ...
   // Ajout de l'élément "physical treatment" avec ses sous-éléments
{
...
},
  {
    ...
    submenu: [
      {
        path: '/admin/surgical/all-surgical',
        title: 'Surgical List',
        iconType: '',
        icon: '',
        class: 'ml-menu',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/patient/appointments/List Appointments',
